    ...
    <footer className="bg-slate-50 border-t border-slate-200 py-12 mt-20">
      <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-600">            <li><Link href="/category/length-converter" className="hover:text-primary">Length</Link></li>
            ...
            <li><a href="#" className="hover:text-primary">EMI Calculator</a></li>          </ul>
        </div>
        <div>
          <span className="font-semibold text-slate-900 block mb-4">Legal & About</span>
          <ul className="space-y-2 text-sm text-slate-600">            <li><Link href="/guides/cm-to-inches" className="hover:text-primary">CM to Inches</Link></li>
            ...
            <li><Link href="/about" className="hover:text-primary">About Us</Link></li>          </ul>
        </div>
        <div>
