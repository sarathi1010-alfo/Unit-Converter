...
const NEW_URLS = [
  ...
  `${SITE_URL}/volume/pt-to-ml`,
  `${SITE_URL}/volume/ml-to-pt`,
  `${SITE_URL}/volume/pt-to-gal`,
  `${SITE_URL}/volume/gal-to-pt`,
  `${SITE_URL}/volume/pt-to-cup`,
  `${SITE_URL}/volume/cup-to-pt`,
  `${SITE_URL}/volume/pt-to-floz`,
  `${SITE_URL}/volume/floz-to-pt`,
  ...
  `${SITE_URL}/weight/mt-to-g`,
  `${SITE_URL}/weight/mt-to-mg`,
  `${SITE_URL}/weight/mt-to-lb`,
  `${SITE_URL}/weight/mt-to-oz`,
  `${SITE_URL}/weight/mt-to-stone`,
  `${SITE_URL}/weight/lb-to-mg`,
  `${SITE_URL}/weight/lb-to-mt`,
  `${SITE_URL}/weight/oz-to-mg`,
  ...
  `${SITE_URL}/length/mm-to-yd`,
  `${SITE_URL}/length/mm-to-mi`,
  `${SITE_URL}/length/mm-to-nm`,
  `${SITE_URL}/length/km-to-yd`,
  `${SITE_URL}/length/km-to-nm`,
  `${SITE_URL}/length/in-to-m`,
  `${SITE_URL}/length/in-to-km`,
  `${SITE_URL}/length/in-to-ft`,
  ...
  `${SITE_URL}/blog/the-complete-guide-to-pressure-conversions-for-mechanics`,
  `${SITE_URL}/pressure/atm-to-psi`,
  `${SITE_URL}/pressure/psi-to-atm`,
  `${SITE_URL}/pressure/bar-to-atm`,
  `${SITE_URL}/pressure/atm-to-bar`,
  `${SITE_URL}/energy/cal-to-kwh`,
  `${SITE_URL}/energy/kwh-to-cal`,
  ...
  `${SITE_URL}/blog/unit-conversions-for-astronomy-and-space`,
  `${SITE_URL}/length/ly-to-km`,
  `${SITE_URL}/length/km-to-ly`,
  `${SITE_URL}/length/au-to-km`,
  `${SITE_URL}/length/km-to-au`,
  `${SITE_URL}/length/ly-to-au`,
  `${SITE_URL}/length/au-to-ly`,
